class ZCL_CUST_INCOMING_PYMT_API_ALL definition
  public
  final
  create public .
...
CLASS ZCL_CUST_INCOMING_PYMT_API_ALL IMPLEMENTATION.
...
*added on 28.09.2023
      ...
      lo_common_check->fi_period_check(
        EXPORTING
          ...
          com_code     =    <fs_input>-comp_code       " Company Code
        IMPORTING
...
*** Posting Date ****
      ...
      READ TABLE lt_log_chk INTO DATA(ls_log_chk) WITH KEY bukrs  = <fs_input>-comp_code
                                                           kunnr  = lv_kunnr
                                                           xblnr  = lv_refdoc
...
* get fiscal year and period - (requires date and company code)
      CALL FUNCTION 'BAPI_COMPANYCODE_GET_PERIOD'
        EXPORTING
          companycodeid = <fs_input>-comp_code
      ...
      IF l_msg IS NOT INITIAL.
        ...
        APPEND VALUE #(  comp_code = <fs_input>-comp_code
                          gl_acnt  = <fs_input>-gl_acnt
...
*** If checks is finished then Inserting data into log table ***
        INSERT INTO zfi_cust_inpymt VALUES @( VALUE #( bukrs        = <fs_input>-comp_code
