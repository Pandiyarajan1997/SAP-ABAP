...
perform bdc_field       using 'P0021-FGBDT'
                            WA_INFOTYPE-datab1. "  '01.01.2011'.
perform bdc_field       using 'P0021-OBJPS'
                              '02'.
