*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_MAP_TABLE_BP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_MAP_TABLE_BP     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_MAP_TABLE_BP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_MAP_TABLE_BP_EXTRACT
TOTAL = ZV_MAP_TABLE_BP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_MAP_TABLE_BP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_MAP_TABLE_BP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_MAP_TABLE_BP_EXTRACT
TOTAL = ZV_MAP_TABLE_BP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_MAP_TABLE_BP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_MAP_TABLE_BP'
...
TOTAL = ZV_MAP_TABLE_BP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_MAP_TABLE_BP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_MAP_TABLE_BP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_MAP_TABLE_BP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_MAP_TABLE_BP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_MAP_TABLE_BP_EXTRACT
TOTAL = ZV_MAP_TABLE_BP_TOTAL
