*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVCUSTTYPE_EXTNS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVCUSTTYPE_EXTNS    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVCUSTTYPE_EXTNS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVCUSTTYPE_EXTNS_EXTRACT
TOTAL = ZVCUSTTYPE_EXTNS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVCUSTTYPE_EXTNS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVCUSTTYPE_EXTNS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVCUSTTYPE_EXTNS_EXTRACT
TOTAL = ZVCUSTTYPE_EXTNS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVCUSTTYPE_EXTNS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVCUSTTYPE_EXTNS'
...
TOTAL = ZVCUSTTYPE_EXTNS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVCUSTTYPE_EXTNS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVCUSTTYPE_EXTNS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVCUSTTYPE_EXTNS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVCUSTTYPE_EXTNS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVCUSTTYPE_EXTNS_EXTRACT
TOTAL = ZVCUSTTYPE_EXTNS_TOTAL
