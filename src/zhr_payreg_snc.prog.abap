*&---------------------------------------------------------------------*
*& Report  ZHR_PAYREG_SNC
*& Requirement given by sivaprasad from danam Infotech
*&----------------------------------------------------------------------*
*&Did by sivakumar M danam infotech for snc
*& HCM:SNC Payregister report for sheenlac
*
*&----------------------------------------------------------------------*
...
DATA : BEGIN OF IT_FINAL OCCURS 0,
  ...
  PERNR1 LIKE PA0008-PERNR,
      " PERNR
       ...
       W_6051  TYPE BETRG,        " Loan repayment ----
       W_6053  TYPE BETRG,        " Variable pay Deduction ----
       W_6055  TYPE BETRG,        " VTDS Refund ----
...
*        W_1200 TYPE BETRG,          " Bonus
        W_6059 TYPE BETRG,          " Bonus     "Added by Danam Siva on 23.11.2015"
...
*        IF DATE1 = DATE2 AND WA_P0000-MASSN = '01'. "Commented by Sivakumar on 27.11.2015"
         IF DATE1 = DATE2 AND WA_P0000-MASSN = '1A'.

          W_PAYDAYS1 = WA_FINAL-CALEN_DAYS - WA_P0000-BEGDA+6(2) .
          W_PAYDAYS1 = W_PAYDAYS1 + 1.
        ENDIF.

*        IF DATE1 = DATE2 AND WA_P0000-MASSN = '18'. "Commented by Sivakumar on 27.11.2015"
         IF DATE1 = DATE2 AND WA_P0000-MASSN = '1R'.

          W_PAYDAYS1 = WA_FINAL-CALEN_DAYS - WA_P0000-BEGDA+6(2) .
          W_PAYDAYS1 = W_PAYDAYS1 + 1.
        ENDIF.

*        IF DATE1 = DATE2 AND WA_P0000-MASSN = '12'. "Commented by Sivakumar on 27.11.2015"
         IF DATE1 = DATE2 AND WA_P0000-MASSN = '1M'.
...
********************
    ...
    ELSEIF WA_FINAL-TOTALDAYS IS NOT INITIAL .
      ...
      WA_FINAL-WORKED_DAYS = WA_FINAL-CALEN_DAYS - WA_FINAL-TOTALDAYS ."- LV_HLOP. "
...
*      ADD wa_rt-BETRG TO WA_FINAL-W_4004.
        ...
        WHEN '6053'.
          ...
          ENDIF.
          ADD WA_RT-BETRG TO WA_FINAL-W_6053. "Variable pay Deduction
        WHEN '6055'.
          IF WA_RT-BETRG < 0.
            WA_RT-BETRG = WA_RT-BETRG * -1.
          ENDIF.
          ADD WA_RT-BETRG TO WA_FINAL-W_6055. "VTDS Refund

        WHEN '6051'. " Loan repayment

          IF WA_RT-BETRG < 0.
            WA_RT-BETRG = WA_RT-BETRG * -1.
          ENDIF.

          ADD WA_RT-BETRG TO WA_FINAL-W_6051  .

        WHEN '6056'.

          ADD WA_RT-BETRG TO WA_FINAL-W_6056.

        WHEN '2013'.

          ADD WA_RT-BETRG TO WA_FINAL-W_2013.

*        WHEN '1200'.   "commended by Danam siva on 23-11-2015
*
*          ADD WA_RT-BETRG TO WA_FINAL-W_1200.
       WHEN '6059'.

          ADD WA_RT-BETRG TO WA_FINAL-W_6059.     "Added by Danam Siva on 23-11-2015"
...
*
          ...
          ADD WA_RT-BETRG TO WA_FINAL-W_6000.

          WHEN '6001'.

          ADD WA_RT-BETRG TO WA_FINAL-W_6001.

          WHEN '6002'.

          ADD WA_RT-BETRG TO WA_FINAL-W_6002.

          WHEN '6003'.

          ADD WA_RT-BETRG TO WA_FINAL-W_6003.
          WHEN '6004'.

          ADD WA_RT-BETRG TO WA_FINAL-W_6004.


          WHEN '6005'.

          ADD WA_RT-BETRG TO WA_FINAL-W_6005.
...
*  ADD WA_RT-BETRG TO WA_FINAL-W_4052.
  WHEN '6057'.
  ADD WA_RT-BETRG TO WA_FINAL-W_6057.
  WHEN '6058'.
  ADD WA_RT-BETRG TO WA_FINAL-W_6058.
...
*
        ...
        WHEN '6054'.
          ...
          ADD WA_RT-BETRG TO WA_FINAL-W_6054.
        ...
        WHEN '6052'.
          ...
          IF WA_RT-BETRG < 0.
            WA_RT-BETRG = WA_RT-BETRG * -1.
          ENDIF.
          ADD WA_RT-BETRG TO WA_FINAL-W_6052.
        ...
        WHEN '6050'.
          ...
          IF WA_RT-BETRG < 0.
            WA_RT-BETRG = WA_RT-BETRG * -1.
          ENDIF.
          ADD WA_RT-BETRG TO WA_FINAL-W_6050.
...
*wA_final-w_tot_hr = wa_final-W_4016 + wa_final-W_4027.
    ...
    WA_FINAL-W_TOT_EARN = WA_FINAL-W_4000 + WA_FINAL-W_4001 + WA_FINAL-W_4002 + WA_FINAL-W_4003 +
                          ...
                          WA_FINAL-W_1009 + WA_FINAL-W_1104 + WA_FINAL-W_6056 + WA_FINAL-W_6059 +
                          ...
                          WA_FINAL-W_6054 + WA_FINAL-W_2021 + WA_FINAL-W_6055  + WA_FINAL-W_4026 +
                          ...
                          WA_FINAL-W_4018 + WA_FINAL-W_4019 + WA_FINAL-W_6000 +
                          WA_FINAL-W_6002 + WA_FINAL-W_6003 + WA_FINAL-W_6001 + WA_FINAL-W_6005 + WA_FINAL-W_6004 + WA_FINAL-W_6057 + WA_FINAL-W_6058.
    ...
    WA_FINAL-W_TOT_DED =  WA_FINAL-W_1100 + WA_FINAL-W_1103 + WA_FINAL-W_1109 + WA_FINAL-W_LXE  +
                          ...
                          WA_FINAL-W_1106 + WA_FINAL-W_1101 + WA_FINAL-W_1102 + WA_FINAL-W_6050 +
                          WA_FINAL-W_ZF5  + WA_FINAL-W_2017 + WA_FINAL-W_6052 + WA_FINAL-W_3F2 + WA_FINAL-W_6051 + WA_FINAL-W_6053 + WA_FINAL-W_ZP1 .
...
*   LS_FIELDCAT-FIELDNAME   = 'W_4017'.
   LS_FIELDCAT-FIELDNAME   = 'W_6002'.
  LS_FIELDCAT-KEY         = ''.
  LS_FIELDCAT-OUTPUTLEN   = '15'.
  LS_FIELDCAT-DO_SUM       = 'X'.
  LS_FIELDCAT-SELTEXT_L =  'Food Coupon'.
  APPEND LS_FIELDCAT TO GT_FIELDCAT.
  CLEAR LS_FIELDCAT .
