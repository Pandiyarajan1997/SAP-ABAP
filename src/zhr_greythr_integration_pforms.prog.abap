...
*Fetching Greytip ID from Infotype Table PA0105 based on selection screen input*
  SELECT pernr
         usrid
    FROM pa0105
      ...
      IF lv_response IS NOT INITIAL.
       ...
       CHANGING
        ...
        IF gs_employee IS NOT INITIAL.
          ...
          PERFORM f_getapi_managerdtls USING lv_empid  <fs_pernr>-pernr.
        ENDIF.
      ELSE.
        APPEND VALUE #(  pernr = <fs_pernr>-pernr
                         infty = '9021'
      ...
      IF lv_response IS NOT INITIAL.
       ...
       CHANGING
        ...
        IF gs_employee IS NOT INITIAL.
          ...
          PERFORM f_get_position_dtls USING lv_empid <fs_pernr>-pernr.
        ENDIF.
      ELSE.
        APPEND VALUE #(  pernr = <fs_pernr>-pernr
                         infty = '9021'
