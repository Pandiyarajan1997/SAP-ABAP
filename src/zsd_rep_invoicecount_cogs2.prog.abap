...
REPORT zsd_rep_invoicecount_cogs2.
...
*       TOT_QUA TYPE FKIMG,
       ...
       BEGIN OF ty_kna1,
         ...
         katr1 TYPE kna1-name2,
         katr2 TYPE kna1-name2,
         katr3 TYPE kna1-name2,
         katr4 TYPE kna1-name2,
         katr5 TYPE kna1-name2,
         katr6 TYPE kna1-name2,
       END OF ty_kna1,
...
TYPES: BEGIN OF ty_tvkbt2,
       ...
       BEGIN OF ty_kna12,
         ...
         name1 TYPE kna1-name1,
         name2 TYPE kna1-name2,
         katr1 TYPE kna1-name1,
         katr2 TYPE kna1-name1,
         katr3 TYPE kna1-name1,
         katr4 TYPE kna1-name1,
         katr5 TYPE kna1-name1,
         katr6 TYPE kna1-name1,
       END OF ty_kna12,
  ...
  SELECT      knumv                                         "13/10
          ...
          FROM prcd_elements " KONV Replaced With PRCD_ELEMENTS Added by <IT-CAR Tool> during Code Remediation - tool
              ...
              kschl EQ 'Y007' OR kschl EQ 'Y008' OR kschl EQ 'ZPRB' OR kschl EQ 'BO01' OR kschl EQ 'ZCAD' OR kschl EQ 'Y004' OR kschl EQ 'YBRD'
               OR kschl EQ 'Z008' OR kschl EQ 'Z009' OR kschl EQ 'Z011' OR kschl EQ 'Z012' ) .
...
*&-------End of Keerthi CLSS on 24-08-2016------*
  ...
  IF it_vbrk_temp IS NOT INITIAL.
    ...
    SELECT * FROM tvk1t INTO TABLE @DATA(lt_tvk1t) WHERE spras = 'E'.
    SELECT * FROM tvk2t INTO TABLE @DATA(lt_tvk2t) WHERE spras = 'E'.
    SELECT * FROM tvk3t INTO TABLE @DATA(lt_tvk3t) WHERE spras = 'E'.
    SELECT * FROM tvk4t INTO TABLE @DATA(lt_tvk4t) WHERE spras = 'E'.
    SELECT * FROM tvk5t INTO TABLE @DATA(lt_tvk5t) WHERE spras = 'E'.
    SELECT * FROM tvk6t INTO TABLE @DATA(lt_tvk6t) WHERE spras = 'E'.
  ENDIF.
...
*    WA_FINOVR-MWSBK = WA_FINOVR-MWSBK.
    ...
    IF sy-subrc = 0.
      ...
      wa_finaldet-attb1 = VALUE #( lt_tvk1t[ katr1 = wa_kna1-katr1 ]-vtext OPTIONAL ).
      wa_finaldet-attb2 = VALUE #( lt_tvk2t[ katr2 = wa_kna1-katr2 ]-vtext OPTIONAL ).
      wa_finaldet-attb3 = VALUE #( lt_tvk3t[ katr3 = wa_kna1-katr3 ]-vtext OPTIONAL ).
      wa_finaldet-attb4 = VALUE #( lt_tvk4t[ katr4 = wa_kna1-katr4 ]-vtext OPTIONAL ).
      wa_finaldet-attb3 = VALUE #( lt_tvk5t[ katr5 = wa_kna1-katr5 ]-vtext OPTIONAL ).
      wa_finaldet-attb6 = VALUE #( lt_tvk6t[ katr6 = wa_kna1-katr6 ]-vtext OPTIONAL ).
    ENDIF.
...
*&-------End of Keerthi CLSS on 24-08-2016------*
    ...
    LOOP AT it_konv INTO wa_konv WHERE knumv = wa_vbrk-knumv AND ( kschl EQ 'YBSD' OR kschl EQ 'Y005' OR kschl EQ 'Y006' OR kschl EQ 'Y029' OR
                                              ...
                                              OR kschl EQ 'Z008' OR kschl EQ 'Z011' OR kschl EQ 'Z012'  ) .
    ...
    LOOP AT it_konv INTO wa_konv WHERE knumv = wa_vbrk-knumv AND ( kschl EQ 'Y008' OR kschl EQ 'Z009' ).
...
*&-------End of Keerthi CLSS on 24-08-2016------*
  ...
  wa_fieldcat-fieldname   = 'ATTB1'.
  wa_fieldcat-seltext_m   = 'Attribute 1'.
  wa_fieldcat-col_pos     = 39.
  wa_fieldcat-do_sum      = 'X'.
  APPEND wa_fieldcat TO it_fieldcat.
  CLEAR  wa_fieldcat.
  wa_fieldcat-fieldname   = 'ATTB2'.
  wa_fieldcat-seltext_m   = 'Attribute 2'.
  wa_fieldcat-col_pos     = 40.
  wa_fieldcat-do_sum      = 'X'.
  APPEND wa_fieldcat TO it_fieldcat.
  CLEAR  wa_fieldcat.
  wa_fieldcat-fieldname   = 'ATTB3'.
  wa_fieldcat-seltext_m   = 'Attribute 3'.
  wa_fieldcat-col_pos     = 41.
  wa_fieldcat-do_sum      = 'X'.
  APPEND wa_fieldcat TO it_fieldcat.
  CLEAR  wa_fieldcat.
  wa_fieldcat-fieldname   = 'ATTB4'.
  wa_fieldcat-seltext_m   = 'Attribute 4'.
  wa_fieldcat-col_pos     = 42.
  wa_fieldcat-do_sum      = 'X'.
  APPEND wa_fieldcat TO it_fieldcat.
  CLEAR  wa_fieldcat.
  wa_fieldcat-fieldname   = 'ATTB5'.
  wa_fieldcat-seltext_m   = 'Attribute 5'.
  wa_fieldcat-col_pos     = 43.
  wa_fieldcat-do_sum      = 'X'.
  APPEND wa_fieldcat TO it_fieldcat.
  CLEAR  wa_fieldcat.
  wa_fieldcat-fieldname   = 'ATTB6'.
  wa_fieldcat-seltext_m   = 'Attribute 6'.
  wa_fieldcat-col_pos     = 44.
  wa_fieldcat-do_sum      = 'X'.
  APPEND wa_fieldcat TO it_fieldcat.
  CLEAR  wa_fieldcat.

  wa_fieldcat-fieldname   = 'GROSS_VAL'.
  wa_fieldcat-seltext_m   = 'Gross Value'.
...
FORM build_alv_overview .
  ...
  LOOP AT it_finovr ASSIGNING FIELD-SYMBOL(<lfs_finovr>).
    CASE <lfs_finovr>-fkart.
      WHEN 'YBRE' OR 'YNRE' OR 'YLRE' OR 'YSRE' OR 'YSRT' OR 'YFRE'.
        IF <lfs_finovr>-tot_y008 < 0.
          <lfs_finovr>-tot_y008 = ( <lfs_finovr>-tot_y008 * -1 ).
        ENDIF.
        IF <lfs_finovr>-inbill < 0.
          <lfs_finovr>-inbill = ( <lfs_finovr>-inbill * -1 ).
        ENDIF.
        IF <lfs_finovr>-tot_y004 < 0.
          <lfs_finovr>-tot_y004 = ( <lfs_finovr>-tot_y004 * -1 ).
        ENDIF.
        <lfs_finovr>-gross_val = <lfs_finovr>-netwr + <lfs_finovr>-inbill + <lfs_finovr>-tot_y004 + <lfs_finovr>-tot_y008.
      WHEN OTHERS.
        IF <lfs_finovr>-tot_y008 < 0.
          <lfs_finovr>-tot_y008 = ( <lfs_finovr>-tot_y008 * -1 ).
        ENDIF.
    ...
    CASE <lfs_finovr>-fkart.
      WHEN 'YBRE' OR 'YNRE' OR 'YLRE' OR 'YSRE' OR 'YSRT' OR 'YFRE'.
      WHEN OTHERS. <lfs_finovr>-tot_y008 = ( <lfs_finovr>-tot_y008 * -1 ).
    ENDCASE.
    <lfs_finovr>-gross_val = <lfs_finovr>-netwr +  <lfs_finovr>-inbill + <lfs_finovr>-tot_y004 - <lfs_finovr>-tot_y008 .
  ENDLOOP.
...
*    wa_finaldet-erdat = wa_vbrk2-erdat.
      ...
      IF sy-subrc = 0.
        ...
        wa_finaldet-attb1 = VALUE #( lt_tvk1t[ katr1 = wa_kna12-katr1 ]-vtext OPTIONAL ).
        wa_finaldet-attb2 = VALUE #( lt_tvk2t[ katr2 = wa_kna12-katr2 ]-vtext OPTIONAL ).
        wa_finaldet-attb3 = VALUE #( lt_tvk3t[ katr3 = wa_kna12-katr3 ]-vtext OPTIONAL ).
        wa_finaldet-attb4 = VALUE #( lt_tvk4t[ katr4 = wa_kna12-katr4 ]-vtext OPTIONAL ).
        wa_finaldet-attb5 = VALUE #( lt_tvk5t[ katr5 = wa_kna12-katr5 ]-vtext OPTIONAL ).
        wa_finaldet-attb6 = VALUE #( lt_tvk6t[ katr6 = wa_kna12-katr6 ]-vtext OPTIONAL ).
      ENDIF.
      ...
      CLEAR wa1_konv.
      LOOP AT it_konv INTO wa1_konv WHERE knumv = wa_vbrk2-knumv AND kposn = wa_vbrk2-posnr AND ( kschl EQ 'Y008' OR kschl EQ 'Z009' ).
        "  IF sy-subrc = 0.
        wa_finaldet-tot_y008 = wa_finaldet-tot_y008 + wa1_konv-kwert .
        " ENDIF.
      ENDLOOP.
...
*&-------End of Keerthi CLSS on 24-08-2016------*
      ...
      CLEAR : wa_finaldet, wa_vbpa1, wa_pa0001_1, wa_vbpa, wa_pa0001,wa_konv,wa1_konv,wa_vbrk2.
      CONTINUE.
    ENDIF.
...
*&-------End of Keerthi CLSS on 24-08-2016------*
      ...
      CLEAR wa_konv.
      LOOP AT it_konv INTO wa_konv WHERE knumv = wa_vbrk2-knumv AND kposn = wa_vbrk2-posnr AND ( kschl EQ 'Y008' OR kschl EQ 'Z009' ).
        "  IF sy-subrc = 0.
        wa_finaldet-tot_y008 = wa_finaldet-tot_y008 + wa_konv-kwert .
        " ENDIF.
      ENDLOOP.

      CLEAR: wa1_konv,wa_konv.
      LOOP AT it_konv INTO wa1_konv WHERE knumv = wa_vbrk2-knumv AND kposn = wa_vbrk2-posnr AND ( kschl EQ 'YBSD' OR kschl EQ 'Y005' OR kschl EQ 'Y006' OR kschl EQ 'Y029' OR
                                           kschl EQ 'Y007' OR kschl EQ 'ZPRB' OR kschl EQ 'BO01' OR kschl EQ 'ZCAD' OR kschl EQ 'YBRD'
                                           OR kschl EQ 'Z008' OR kschl EQ 'Z011' OR kschl EQ 'Z012' ) .
        "  IF sy-subrc = 0.
      ...
      APPEND wa_finaldet TO it_finaldet.
      CLEAR: wa_finaldet, wa_vbpa1, wa_pa0001_1, wa_vbpa, wa_pa0001,wa_konv,wa1_konv.
    ENDIF.
...
*    CLEAR WA_TEMP_FINDET.
    ...
    CLEAR: wa_vbpa1, wa_pa0001_1, wa_vbpa, wa_pa0001,wa_konv,wa1_konv.
...
FORM build_alv_detail .
  ...
  LOOP AT it_finaldet ASSIGNING FIELD-SYMBOL(<lfs_finaldet>).
    CASE <lfs_finaldet>-fkart.
      WHEN 'YBRE' OR 'YNRE' OR 'YLRE' OR 'YSRE' OR 'YSRT' OR 'YFRE'.
        IF <lfs_finaldet>-tot_y008 < 0.
          <lfs_finaldet>-tot_y008 = ( <lfs_finaldet>-tot_y008 * -1 ).
        ENDIF.
        IF <lfs_finaldet>-inbill1 < 0.
          <lfs_finaldet>-inbill1 = ( <lfs_finaldet>-inbill1 * -1 ).
        ENDIF.
        IF <lfs_finaldet>-tot_y004 < 0.
          <lfs_finaldet>-tot_y004 = ( <lfs_finaldet>-tot_y004 * -1 ).
        ENDIF.
        <lfs_finaldet>-gross_val = <lfs_finaldet>-vnetwr + <lfs_finaldet>-inbill1 + <lfs_finaldet>-tot_y004 + <lfs_finaldet>-tot_y008.
      WHEN OTHERS.
        IF <lfs_finaldet>-tot_y008 < 0.
          <lfs_finaldet>-tot_y008 = ( <lfs_finaldet>-tot_y008 * -1 ).
        ENDIF.
