FUNCTION zbapi_cust_open_item_bsid_dms.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
*"     VALUE(LT_DISTRIBUTOR) TYPE  KUNNR_TTY OPTIONAL
*"  TABLES
*"      LT_OPEN_ITEMS STRUCTURE  ZSTR_OPEN_ITEMS_BSID_DMS
...
*  SORT : lt_open_items BY distributor dealer budat,
*         lt_crbalance  BY distributor dealer.
