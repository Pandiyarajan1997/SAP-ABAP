...
REPORT ZPROCESS_ORDER_DETAILS11.
...
DATA : HEADER        TYPE TABLE OF BAPI_ORDER_HEADER1 ,
       ...
       PHASE         TYPE TABLE OF BAPI_ORDER_PHASE,"   OCCURS 1,
...
DATA : WA_PHASE      TYPE BAPI_ORDER_PHASE.
...
*if affv is NOT INITIAL.
      ...
      CALL FUNCTION 'SSF_FUNCTION_MODULE_NAME'
        EXPORTING
          FORMNAME           = 'ZPROCESS_ORDER_DETAILS1122'
*         VARIANT            = ' '
*         DIRECT_CALL        = ' '
        IMPORTING
          FM_NAME            = FM_NAME
