...
DATBI(10) TYPE  C,
   MWSK1  TYPE    KONP-MWSK1,
        ...
        DATA: ITAB TYPE  TABLE OF jivaa831,
      WA_ITAB TYPE  jivaa831.
...
perform bdc_field       using 'RV130-SELKZ(02)'
                              'X'.
perform bdc_dynpro      using 'SAPMV13A' '1929'.
perform bdc_field       using 'BDC_CURSOR'
                              'KONP-MWSK1(01)'.
perform bdc_field       using 'BDC_OKCODE'
                              '/00'.
