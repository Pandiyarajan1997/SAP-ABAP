*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_API_CHK_TABLE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_API_CHK_TABLE    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_API_CHK_TABLE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_API_CHK_TABLE_EXTRACT
TOTAL = ZV_API_CHK_TABLE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_API_CHK_TABLE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_API_CHK_TABLE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_API_CHK_TABLE_EXTRACT
TOTAL = ZV_API_CHK_TABLE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_API_CHK_TABLE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_API_CHK_TABLE'
...
TOTAL = ZV_API_CHK_TABLE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_API_CHK_TABLE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_API_CHK_TABLE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_API_CHK_TABLE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_API_CHK_TABLE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_API_CHK_TABLE_EXTRACT
TOTAL = ZV_API_CHK_TABLE_TOTAL
