...
*******************************************************************
  INCLUDE LZFG_CUSGRP_TABTOP.                " Global Declarations
  INCLUDE LZFG_CUSGRP_TABUXX.                " Function Modules

*******************************************************************
*   User-defined Include-files (if necessary).                    *
*******************************************************************
* INCLUDE LZFG_CUSGRP_TABF...                " Subroutines
* INCLUDE LZFG_CUSGRP_TABO...                " PBO-Modules
* INCLUDE LZFG_CUSGRP_TABI...                " PAI-Modules
* INCLUDE LZFG_CUSGRP_TABE...                " Events
* INCLUDE LZFG_CUSGRP_TABP...                " Local class implement.
* INCLUDE LZFG_CUSGRP_TABT99.                " ABAP Unit tests
