...
DATBI(10) TYPE  C,
  ...
  DATA:IT_VK11 TYPE TABLE OF jivaa835 ,
        WA_VK11 TYPE jivaa835 .
...
perform bdc_field       using 'RV130-SELKZ(03)'
                              'X'.
perform bdc_dynpro      using 'SAPMV13A' '1930'.
perform bdc_field       using 'BDC_CURSOR'
                              'KONP-MWSK1(01)'.
perform bdc_field       using 'BDC_OKCODE'
                              '/00'.
perform bdc_field       using 'KOMG-ALAND'
                              WA_VK11-ALAND ." 'IN'.
perform bdc_field       using 'KOMG-VKBUR(01)'
                             WA_VK11-VKBUR.  " '1000'.
...
WA_FINAL-STATUS = I_BDCMSG-MSGTYP.
    ...
    CONCATENATE WA_VK11-VKBUR 'Ended with Error' INTO WA_FINAL-MESSAGE SEPARATED BY SPACE.
...
WA_FINAL-STATUS =  I_BDCMSG-MSGTYP.
    CONCATENATE WA_VK11-VKBUR 'Saved Successfully' INTO WA_FINAL-MESSAGE SEPARATED BY SPACE.
WA_FINAL-FIELD = I_BDCMSG-MSGV1.
WA_FINAL-FIELD1 = I_BDCMSG-MSGV2.
    ENDIF.
