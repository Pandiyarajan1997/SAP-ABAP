...
*       STCD3 TYPE KNA1-STCD3,                  " Tax Number 3 "GSTIN / UniqueID
       END OF GS_KNA1.
...
FORM READ_DATA1 .
  ...
  LOOP AT GT_BSID INTO WA_BSID.
    ...
    WA_FINAL-BUKRS = WA_BSID-BUKRS.                         " add by mani
...
***********************************************************************************
    ...
    IF GS_CHK-BUDAT = WA_BSID-BUDAT AND
         GS_CHK-BLART = WA_BSID-BLART AND
         GS_CHK-BELNR = WA_BSID-BELNR AND
        GS_CHK-SHKZG = WA_BSID-SHKZG AND
         WA_BSID-SHKZG = 'H'.
    ...
    ELSEIF GS_CHK-BUDAT = WA_BSID-BUDAT AND
         GS_CHK-BLART = WA_BSID-BLART AND
         GS_CHK-BELNR = WA_BSID-BELNR AND
         GS_CHK-SHKZG = WA_BSID-SHKZG AND
         WA_BSID-SHKZG = 'S'.
    ...
    ELSEIF ( GS_CHK-BUDAT <> WA_BSID-BUDAT AND
         ...
         GS_CHK-BELNR <> WA_BSID-BELNR AND
          WA_BSID-SHKZG <> 'S' ) OR
           ( ( GS_CHK-BUDAT <> WA_BSID-BUDAT OR
         GS_CHK-BLART <> WA_BSID-BLART OR
         GS_CHK-BELNR <> WA_BSID-BELNR ) AND
          WA_BSID-SHKZG <> 'S' ) OR
             ( GS_CHK-SHKZG <> WA_BSID-SHKZG AND WA_BSID-SHKZG <> 'S' ) .
    ...
    ELSEIF ( GS_CHK-BUDAT <> WA_BSID-BUDAT AND
         GS_CHK-BLART <> WA_BSID-BLART AND
         GS_CHK-BELNR <> WA_BSID-BELNR AND WA_BSID-SHKZG <> 'H' ) OR
           ( ( GS_CHK-BUDAT <> WA_BSID-BUDAT OR
         GS_CHK-BLART <> WA_BSID-BLART OR
         GS_CHK-BELNR <> WA_BSID-BELNR ) AND
          WA_BSID-SHKZG <> 'H' ) OR
        ( GS_CHK-SHKZG <> WA_BSID-SHKZG AND WA_BSID-SHKZG <> 'H' ) .
    ...
    ELSEIF ( GS_CHK-BUDAT <> WA_BSID-BUDAT AND
                GS_CHK-BLART <> WA_BSID-BLART AND
          GS_CHK-BELNR <> WA_BSID-BELNR AND
          GS_CHK-SHKZG <> WA_BSID-SHKZG AND WA_BSID-SHKZG = 'C' )
          OR
         WA_T003T-BLART = 'AB'.
    ...
    ELSEIF ( GS_CHK-BUDAT <> WA_BSID-BUDAT AND
         GS_CHK-BLART <> WA_BSID-BLART AND
         GS_CHK-BELNR <> WA_BSID-BELNR AND
         GS_CHK-SHKZG <> WA_BSID-SHKZG AND WA_BSID-SHKZG = 'D')
          OR
         WA_T003T-BLART = 'AB'.
...
*        WA_FINAL-CR_AMT = LV_CRAMT + WA_BSID-DMBTR.
*        LV_CRAMT = WA_FINAL-CR_AMT.
*        READ TABLE GT_FINAL INTO WA_FINAL INDEX LV_IND.
*        IF SY-SUBRC EQ 0 AND WA_FINAL-SHKZG NE 'S'.
*          DELETE GT_FINAL INDEX LV_IND.
*        ENDIF.
*
*
...
*        LV_DBAMT = WA_FINAL-DR_AMT.
*        READ TABLE GT_FINAL INTO WA_FINAL INDEX LV_IND.
*        IF SY-SUBRC EQ 0 AND WA_FINAL-SHKZG NE 'H'.
*          DELETE GT_FINAL INDEX LV_IND.
*        ENDIF.
*
*      ELSEIF WA_BSID-SHKZG = 'C' AND WA_T003T-BLART = 'AB'.
*        WA_FINAL-CR_AMT = LV_CRAMT + WA_FINAL-SKNTO .
*        LV_CRAMT = WA_FINAL-CR_AMT.
*        READ TABLE GT_FINAL INTO WA_FINAL INDEX LV_IND.
*        IF SY-SUBRC EQ 0 AND WA_FINAL-SHKZG NE 'D'.
*          DELETE GT_FINAL INDEX LV_IND.
*        ENDIF.
*
*
*      ELSEIF WA_BSID-SHKZG = 'D' AND WA_T003T-BLART = 'AB'.
*        WA_FINAL-DR_AMT = LV_DBAMT + WA_FINAL-SKNTO .
*        LV_DBAMT = WA_FINAL-DR_AMT.
*        READ TABLE GT_FINAL INTO WA_FINAL INDEX LV_IND.
*        IF SY-SUBRC EQ 0 AND WA_FINAL-SHKZG NE 'C'.
*          DELETE GT_FINAL INDEX LV_IND.
*        ENDIF.
*
*      ENDIF.
...
*    WA_FINAL-KUNNR = WA_BSID-KUNNR.
*    WA_FINAL-BELNR = WA_BSID-BELNR.
*    GS_CHK-BELNR = WA_BSID-BELNR. " Chk
*    WA_FINAL-BUDAT = WA_BSID-BUDAT.
*    GS_CHK-BUDAT = WA_BSID-BUDAT. " Chk
*    WA_FINAL-GSBER = WA_BSID-GSBER.
*    WA_FINAL-SGTXT = WA_BSID-SGTXT.
*    WA_FINAL-VBELN = WA_BSID-VBELN.
*    WA_FINAL-UMSKZ = WA_BSID-UMSKZ.
*    WA_FINAL-BUKRS = WA_BSID-BUKRS.                         " add by mani
*    READ TABLE GT_T003T INTO WA_T003T WITH KEY BLART = WA_BSID-BLART.
*    GS_CHK-BLART = WA_BSID-BLART. " Chk
*    WA_FINAL-LTEXT = WA_T003T-LTEXT.
*    WA_FINAL-BLART = WA_BSID-BLART.
*    READ TABLE GT_KNA1 INTO WA_KNA1 WITH KEY KUNNR = WA_BSID-KUNNR.
*    WA_FINAL-NAME1 = WA_KNA1-NAME1.
...
*ADDED PRAM ON 05/10
*    READ TABLE GT_BSAD7 INTO WA_BSAD7 WITH KEY BELNR =  WA_BSID-BELNR SHKZG = WA_BSID-SHKZG AUGBL = WA_BSID-AUGBL .
*    IF  WA_BSAD7-SKNTO > 0  AND WA_BSAD7-BLART EQ 'DZ' AND WA_BSAD7-SHKZG = 'H'.
*      WA_FINAL-CR_AMT = WA_FINAL-CR_AMT - WA_BSAD7-SKNTO.
*      APPEND WA_FINAL TO GT_FINAL.
*      CLEAR: WA_FINAL-CR_AMT.
*      WA_FINAL-CR_AMT = WA_BSAD7-SKNTO.
*      APPEND WA_FINAL TO GT_FINAL.
*      CLEAR: WA_BSAD7.
*    ELSE.
*      APPEND WA_FINAL TO GT_FINAL.
...
*  SORT GT_FINAL DESCENDING BY BUDAT BLART BELNR CR_AMT.
*
*  DELETE ADJACENT DUPLICATES FROM GT_FINAL COMPARING BUDAT BLART BELNR.

*  SORT GT_FINAL DESCENDING BY BUDAT BLART BELNR DR_AMT.
*
*  DELETE ADJACENT DUPLICATES FROM GT_FINAL COMPARING BUDAT BLART BELNR.
  ...
  LOOP AT GT_FINAL1 INTO WA_FINAL1.
    ...
    IF GS_CHK-BUDAT = WA_FINAL1-BUDAT AND
      ...
      IF WA_FINAL1-CR_AMT GT GS_CHK-CR_AMT.
        ...
        GS_LINE-LN = SY-TABIX.
*
*    APPEND WA_FINAL1 TO GT_FINAL.
*
      ENDIF.

      IF WA_FINAL1-DR_AMT GT GS_CHK-DR_AMT.
...
*         GS_CHK-BELNR = WA_FINAL1-BELNR.
*
*      READ TABLE GT_T003T INTO WA_T003T WITH KEY BLART = WA_FINAL1-BLART.
*
*      IF WA_FINAL1-SHKZG = 'H' AND WA_FINAL1-CR_AMT GT GS_CHK-CR_AMT.
*
*    MODIFY GT_FINAL FROM WA_FINAL TRANSPORTING CR_AMT.
**        MODIFY GT_FINAL1 FROM  WA_FINAL1.
**        CLEAR : WA_FINAL1.
*
**        wa_final1-CR_AMT = LV_CRAMT + WA_BSID-DMBTR.
**        LV_CRAMT = wa_final1-CR_AMT.
*      ELSEIF WA_FINAL1-SHKZG = 'S' AND WA_FINAL1-dR_AMT GT GS_CHK-dR_AMT.
**        wa_final1-DR_AMT = LV_DBAMT + WA_BSID-DMBTR.
**        LV_DBAMT = wa_final1-DR_AMT.
*
*    MODIFY GT_FINAL FROM WA_FINAL TRANSPORTING DR_AMT.
*
**        MODIFY GT_FINAL1 FROM  WA_FINAL1.
**        CLEAR : WA_FINAL1.
*
*
*      ELSEIF WA_FINAL1-SHKZG = 'C' AND WA_T003T-BLART = 'AB' AND WA_FINAL1-CR_AMT GT GS_CHK-CR_AMT.
**        wa_final1-CR_AMT = LV_CRAMT + wa_final1-SKNTO .
**        LV_CRAMT = wa_final1-CR_AMT.
*
**        MODIFY GT_FINAL1 FROM  WA_FINAL1.
**        CLEAR : WA_FINAL1.
*    MODIFY GT_FINAL FROM WA_FINAL TRANSPORTING CR_AMT.
*
*      ELSEIF WA_FINAL1-SHKZG = 'D' AND WA_T003T-BLART = 'AB' AND WA_FINAL1-dR_AMT GT GS_CHK-dR_AMT.
**        wa_final1-DR_AMT = LV_DBAMT + wa_final1-SKNTO .
**        LV_DBAMT = wa_final1-DR_AMT.
*
**        MODIFY GT_FINAL1 FROM  WA_FINAL1.
**        CLEAR : WA_FINAL1.
...
*
*
*      IF WA_FINAL1-SHKZG = 'H'.
*
**        MODIFY GT_FINAL1 FROM  WA_FINAL1.
**        CLEAR : WA_FINAL1.
*
**        wa_final1-CR_AMT = WA_BSID-DMBTR.
**        LV_CRAMT = wa_final1-CR_AMT.
*
*
*    MODIFY GT_FINAL FROM WA_FINAL TRANSPORTING CR_AMT.
*
*      ELSEIF WA_FINAL1-SHKZG = 'S'.
*
*    MODIFY GT_FINAL FROM WA_FINAL TRANSPORTING DR_AMT.
**        MODIFY GT_FINAL1 FROM  WA_FINAL1.
**        CLEAR : WA_FINAL1.
*
**        wa_final1-DR_AMT = WA_BSID-DMBTR.
**        LV_DBAMT = wa_final1-DR_AMT.
*      ELSEIF WA_FINAL1-SHKZG = 'C' AND WA_T003T-BLART = 'AB'.
*
**        MODIFY GT_FINAL1 FROM  WA_FINAL1.
**        CLEAR : WA_FINAL1.
*
**        wa_final1-CR_AMT = wa_final1-SKNTO .
**        LV_CRAMT = wa_final1-CR_AMT.
*    MODIFY GT_FINAL FROM WA_FINAL TRANSPORTING CR_AMT.
*
*      ELSEIF WA_FINAL1-SHKZG = 'D' AND WA_T003T-BLART = 'AB'.
*
**        MODIFY GT_FINAL1 FROM  WA_FINAL1.
**        CLEAR : WA_FINAL1.
*
**        wa_final1-DR_AMT = wa_final1-SKNTO .
**        LV_DBAMT = wa_final1-DR_AMT.
*    MODIFY GT_FINAL FROM WA_FINAL TRANSPORTING DR_AMT.
*
*      ENDIF.
...
*    wa_final1-XBLNR = WA_BSID-XBLNR.
*    wa_final1-BLDAT = WA_BSID-BLDAT.
*    wa_final1-KUNNR = WA_BSID-KUNNR.
*    wa_final1-BELNR = WA_BSID-BELNR.
*    GS_CHK-BELNR = WA_BSID-BELNR. " Chk
*    wa_final1-BUDAT = WA_BSID-BUDAT.
*    GS_CHK-BUDAT = WA_BSID-BUDAT. " Chk
*    wa_final1-GSBER = WA_BSID-GSBER.
*    wa_final1-SGTXT = WA_BSID-SGTXT.
*    wa_final1-VBELN = WA_BSID-VBELN.
*    wa_final1-UMSKZ = WA_BSID-UMSKZ.
*    wa_final1-BUKRS = WA_BSID-BUKRS.                         " add by mani
*    READ TABLE GT_T003T INTO WA_T003T WITH KEY BLART = WA_BSID-BLART.
*    GS_CHK-BLART = WA_BSID-BLART. " Chk
*    wa_final1-LTEXT = WA_T003T-LTEXT.
*    wa_final1-BLART = WA_BSID-BLART.
*    READ TABLE GT_KNA1 INTO WA_KNA1 WITH KEY KUNNR = WA_BSID-KUNNR.
*    wa_final1-NAME1 = WA_KNA1-NAME1.
*    wa_final1-SHKZG = WA_BSID-SHKZG.
...
*  SORT GT_FINAL DESCENDING BY BUDAT BLART BELNR SHKZG CR_AMT.
*
*  DELETE ADJACENT DUPLICATES FROM GT_FINAL COMPARING BUDAT BLART BELNR SHKZG.
*
*  SORT GT_FINAL DESCENDING BY BUDAT BLART BELNR SHKZG DR_AMT.
*
*  DELETE ADJACENT DUPLICATES FROM GT_FINAL COMPARING BUDAT BLART BELNR SHKZG.

*  DELETE ADJACENT DUPLICATES FROM GT_FINAL USING KEY
*  SORT GT_FINAL DESCENDING BY BUDAT BLART BELNR DR_AMT.
*
*  DELETE ADJACENT DUPLICATES FROM GT_FINAL COMPARING BUDAT BLART BELNR.
...
*  DELETE GT_FINAL[] WHERE BLART = 'AB' AND SKNTO = '0.00' .
...
*    endif.
  ...
  CALL FUNCTION 'SSF_FUNCTION_MODULE_NAME'
    EXPORTING
      FORMNAME           = 'ZSF_CUS_ACCOUNT_REC_LEDGER1'
*     VARIANT            = ' '
*     DIRECT_CALL        = ' '
    IMPORTING
      FM_NAME            = FM_NAME
