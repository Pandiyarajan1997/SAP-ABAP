*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_BP_SOFFICE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_BP_SOFFICE       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_BP_SOFFICE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_BP_SOFFICE_EXTRACT
TOTAL = ZV_BP_SOFFICE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_BP_SOFFICE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_BP_SOFFICE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_BP_SOFFICE_EXTRACT
TOTAL = ZV_BP_SOFFICE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_BP_SOFFICE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_BP_SOFFICE'
...
TOTAL = ZV_BP_SOFFICE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_BP_SOFFICE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_BP_SOFFICE-UPD_FLAG NE SPACE.
