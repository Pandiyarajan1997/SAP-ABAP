...
*& Verified By                 :                                       *
*& Title                       : Professional Tax - India              *
*& Report Name                 : ZHR_PTAX                              *
*& Development Id              : kpabap                                *
*& Related Information         : Professional Tax - India              *
*&---------------------------------------------------------------------*
    ...
    LOOP AT IT_RT INTO WA_RT.
      ...
      CASE WA_RT-LGART.
        ...
        WHEN '/101'.
          ...
          ADD WA_RT-BETRG TO WA_FINAL-W_101.

        WHEN '/3P1'.

          ADD WA_RT-BETRG TO WA_FINAL-W_3P1.
*
        WHEN '/ZP1'.
...
*
    ...
    WA_FINAL-W_TOT = WA_FINAL-W_3P1 + WA_FINAL-W_ZP1.
...
*
***** Added By Govind *************
  DELETE IT_FINAL WHERE W_101 LE 0.
...
*l_layout-SUBTOTALS_TEXT = 'SUBTOTAL'.
  ...
  L_LAYOUT-COLWIDTH_OPTIMIZE = 'X'.                     " Changes by Savariar s
  L_LAYOUT-ZEBRA = 'X'.
...
*     i_callback_program = sy-cprog
      I_GRID_TITLE       = 'Professional Tax -India'
      IS_LAYOUT          = L_LAYOUT
...
*  CLEAR LS_FIELDCAT .
  ...
  LS_FIELDCAT-FIELDNAME   = 'W_101'.
  LS_FIELDCAT-KEY         = ''.
  LS_FIELDCAT-OUTPUTLEN   = '15'.
  LS_FIELDCAT-DO_SUM       = 'X'.
  LS_FIELDCAT-SELTEXT_L =  'Gross salary'.
  APPEND LS_FIELDCAT TO GT_FIELDCAT.
  CLEAR LS_FIELDCAT .
*
  CLEAR LS_FIELDCAT.
