...
perform bdc_field       using 'P0022-ANZKL'
                             WA_INFOTYPE-year." '  4'.
perform bdc_field       using 'Q0022-ANZEH'
                              'Years'.
perform bdc_dynpro      using 'MP002200' '2000'.
perform bdc_field       using 'BDC_CURSOR'
                              'P0022-BEGDA'.
