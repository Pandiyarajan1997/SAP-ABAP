...
TYPES: BEGIN OF STR_ZWATBASE_TABLE,
        ...
        MATNR_ALT(30) TYPE C,
        MATNR_PRO  TYPE TEXT300,
        MATNR_PRO1 TYPE TEXT300,
        MATNR_PRO2 TYPE TEXT300,
        MATNR_PRO3 TYPE TEXT300,
...
* Implement suitable error handling here
  ...
  LOOP AT IT_ZWA_BASE_TABLE INTO WA_ZWA_BASE_TABLE .
    ...
    PERFORM BDC_DYNPRO      USING 'SAPLZWATER_BASE' '9999'.
    PERFORM BDC_FIELD       USING 'BDC_CURSOR'
                                   'ZWATBASE_TABLE-ALTERNATIVE(01)'.
...
*                              WA_ZWA_BASE_TABLE-SL_NO ."  ' 103'.
    PERFORM BDC_FIELD       USING 'ZWATBASE_TABLE-PLANT(01)'
                                  WA_ZWA_BASE_TABLE-PLANT ."  ' 103'.
    PERFORM BDC_FIELD       USING 'ZWATBASE_TABLE-ALTERNATIVE(01)'
                                  WA_ZWA_BASE_TABLE-ALTERNATIVE . " '1'.
    PERFORM BDC_FIELD       USING 'ZWATBASE_TABLE-MATNR(01)'
                                   WA_ZWA_BASE_TABLE-MATNR .  " 'ENAFA501'.
    PERFORM BDC_FIELD       USING 'ZWATBASE_TABLE-STAGE(01)'
                                   WA_ZWA_BASE_TABLE-STAGE. " '2'.
    PERFORM BDC_FIELD       USING 'ZWATBASE_TABLE-MATNR_ALT(01)'
                                  WA_ZWA_BASE_TABLE-MATNR_ALT. "'TESTING'.
    PERFORM BDC_FIELD       USING 'ZWATBASE_TABLE-MATNR_PRO(01)'
                                  WA_ZWA_BASE_TABLE-MATNR_PRO.  "'TESTING2'.
    PERFORM BDC_FIELD       USING 'ZWATBASE_TABLE-MATNR_PRO1(01)'
                                  WA_ZWA_BASE_TABLE-MATNR_PRO1.  "'TESTING2'.
    PERFORM BDC_FIELD       USING 'ZWATBASE_TABLE-MATNR_PRO2(01)'
                                  WA_ZWA_BASE_TABLE-MATNR_PRO2.  "'TESTING2'.
    PERFORM BDC_FIELD       USING 'ZWATBASE_TABLE-MATNR_PRO3(01)'
                                  WA_ZWA_BASE_TABLE-MATNR_PRO3.  "'TESTING3'.
    PERFORM BDC_DYNPRO      USING 'SAPLZWATER_BASE' '9999'.
    PERFORM BDC_FIELD       USING 'BDC_CURSOR'
    ...
    "'104'.
    "perform bdc_field       using 'ZWATBASE_TABLE-ALTERNATIVE(02)'
    "                             '2'.
    ...
    CALL TRANSACTION 'ZBATCH_REVIEW' USING BDCDATA MODE P_MODE UPDATE P_UPDATE MESSAGES INTO IT_MSGTAB.
    CLEAR BDCDATA.
    REFRESH BDCDATA[].
