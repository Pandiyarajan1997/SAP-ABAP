"Name: \PR:RQCAAP02\FO:USER_VARIANT\SE:BEGIN\EI
...
SELECT * FROM MAKT INTO LV_MAKT WHERE MATNR = P_MATNR
ORDER BY PRIMARY KEY. "Added by SPLABAP during code remediation
ENDSELECT.

MAKT-MAKTX = LV_MAKT-MAKTX.
...
ENDIF.
  ...
  ELSE.
    MESSAGE 'ENTER MATERIAL NUMBER AND BATCH' TYPE 'E'.
  ENDIF.
