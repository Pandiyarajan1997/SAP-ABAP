*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_CUST_COMMS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_CUST_COMMS       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_CUST_COMMS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_CUST_COMMS_EXTRACT
TOTAL = ZV_CUST_COMMS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_CUST_COMMS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_CUST_COMMS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_CUST_COMMS_EXTRACT
TOTAL = ZV_CUST_COMMS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_CUST_COMMS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_CUST_COMMS'
...
TOTAL = ZV_CUST_COMMS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_CUST_COMMS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_CUST_COMMS-UPD_FLAG NE SPACE.
