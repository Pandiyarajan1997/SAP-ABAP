...
INITIALIZATION.
  ...
  GWA_LIST-KEY = '2'.
  GWA_LIST-TEXT = 'Sales Off./Cust.Group/Material'.
  APPEND GWA_LIST TO GT_LIST.
  CLEAR: GWA_LIST.

  GWA_LIST-KEY = '3'.
  GWA_LIST-TEXT = 'Region/Cust.group/Material'.
  APPEND GWA_LIST TO GT_LIST.
  CLEAR: GWA_LIST.
...
AT SELECTION-SCREEN.
  ...
  IF GWA_VALUES-FIELDVALUE = 1.
    ...
    CALL TRANSACTION 'ZY005_BDC1'.

  ENDIF.

  IF GWA_VALUES-FIELDVALUE = 2.

    CALL TRANSACTION 'ZY005_SALES_BDC'.

  ENDIF.

  IF GWA_VALUES-FIELDVALUE = 3.

    CALL TRANSACTION 'ZCOND'.
