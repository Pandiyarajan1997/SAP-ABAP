...
SORT gt_mchb by matnr werks lgort charg ersda.
...
*      DATA(is_flag) = abap_true.
     ELSE.
      SELECT
         ...
         clabs,
        cinsm,
         cspem FROM mchb INTO TABLE @data(gt_mchb_cop) FOR ALL ENTRIES IN @gt_mara
...
** if old material created date is empty , then take the new material date by batch
        ...
        ENDIF.
        ELSE.
*         READ TABLE gt_mchb_bismt INTO wa_mchb_bismt WITH KEY matnr = wa_mchb-matnr charg = wa_mchb-charg BINARY SEARCH.
*        IF sy-subrc = 0.
*          wa4-ersda4 = wa_mchb_bismt-ersda.
*        ENDIF.
        wa4-ersda4 = wa_mchb-ersda.
...
*           BEGDA = WA_MCHB-ERSDA                                                                        " hided by mani 13.02.2016
        ...
        ELSEIF t_days BETWEEN  181 AND 365."t_days > 180. "added by zakir 13/09/2024
