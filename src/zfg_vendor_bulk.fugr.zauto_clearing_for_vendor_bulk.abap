FUNCTION zauto_clearing_for_vendor_bulk.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"     REFERENCE(INV_REFNO) TYPE  XBLNR1 OPTIONAL
...
*Changed On: 19.05.2023 *Changed By: Samsudeen M
    ...
    lt_ftpost = VALUE #(
               ...
               ( stype = 'K' count = lv_count     fnam = 'BKPF-BLART' fval = doc_type )
