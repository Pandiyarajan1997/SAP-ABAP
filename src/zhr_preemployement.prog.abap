...
REPORT ZHR_PREEMPLOYEMENT NO
 STANDARD  PAGE HEADING LINE-SIZE 255.
...
perform bdc_field       using 'P0023-BEGDA'
                             WA_INFOTYPE-datab. " '01.02.2014'.
perform bdc_field       using 'P0023-ENDDA'
                             WA_INFOTYPE-datab1. " '10.11.2015'.
perform bdc_field       using 'P0023-ARBGB'
                             WA_INFOTYPE-company. " 'TCS'.
...
perform bdc_field       using 'P0023-BRANC'
                              '0007'.
perform bdc_field       using 'P0023-TAETE'
                              '11'.
perform bdc_field       using 'P0023-ANSVX'
                              '01'.
perform bdc_dynpro      using 'MP002300' '2000'.
perform bdc_field       using 'BDC_CURSOR'
                              'P0023-BEGDA'.
