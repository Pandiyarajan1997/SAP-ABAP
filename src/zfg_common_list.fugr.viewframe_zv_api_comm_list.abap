*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_API_COMM_LIST
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_API_COMM_LIST    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_API_COMM_LIST'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_API_COMM_LIST_EXTRACT
TOTAL = ZV_API_COMM_LIST_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_API_COMM_LIST'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_API_COMM_LIST-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_API_COMM_LIST_EXTRACT
TOTAL = ZV_API_COMM_LIST_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_API_COMM_LIST-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_API_COMM_LIST'
...
TOTAL = ZV_API_COMM_LIST_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_API_COMM_LIST-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_API_COMM_LIST-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_API_COMM_LIST'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_API_COMM_LIST-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_API_COMM_LIST_EXTRACT
TOTAL = ZV_API_COMM_LIST_TOTAL
