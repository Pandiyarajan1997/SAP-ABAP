class ZCL_API_DMS_EWAYBILL_CREATE definition
  public
  final
  create public .
...
CLASS ZCL_API_DMS_EWAYBILL_CREATE IMPLEMENTATION.
...
*-------------------------------------------------------------------------------------
    ...
    DATA: gt_input TYPE STANDARD TABLE OF zst_ewaybill_dms,
          gs_input TYPE zst_ewaybill_dms.
...
** Deserialize the input our required input ***
   ...
   CHANGING
    ...
    IF gs_input IS NOT INITIAL.
      ...
      ENDIF.
      IF gs_input-distrb IS INITIAL.
        APPEND VALUE #( msg = |Distributor code is missing| ) TO gt_output.
      ENDIF.
      IF gs_input-dealer IS INITIAL.
        APPEND VALUE #( msg = |Dealer code is missing| ) TO gt_output.
      ENDIF.
      ...
      SELECT SINGLE irn
        ...
        WHERE bukrs = @gs_input-bukrs AND
              distrb = @gs_input-distrb AND
              dealer = @gs_input-dealer AND
              docno = @gs_input-vbeln.
