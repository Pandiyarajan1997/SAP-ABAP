*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVALPN_MATERIAL
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVALPN_MATERIAL     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVALPN_MATERIAL'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVALPN_MATERIAL_EXTRACT
TOTAL = ZVALPN_MATERIAL_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVALPN_MATERIAL'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVALPN_MATERIAL-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVALPN_MATERIAL_EXTRACT
TOTAL = ZVALPN_MATERIAL_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVALPN_MATERIAL-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVALPN_MATERIAL'
...
TOTAL = ZVALPN_MATERIAL_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVALPN_MATERIAL-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVALPN_MATERIAL-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVALPN_MATERIAL'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVALPN_MATERIAL-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVALPN_MATERIAL_EXTRACT
TOTAL = ZVALPN_MATERIAL_TOTAL
