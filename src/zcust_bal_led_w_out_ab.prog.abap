...
*********************** Added on 17-10-2014  By Govind ********************************
 ...
 "  DELETE GT_BSID WHERE BLART = 'AB'  . "19/02/2018
 "  DELETE GT_BSID1 WHERE BLART = 'AB' .
...
************************ Added on 17-10-2014  By Govind ********************************
  ...
  DELETE GT_FINAL[] WHERE BLART = 'AB'  .  "DATED ON 17/2/2018
...
*    endif.
  ...
  CALL FUNCTION 'SSF_FUNCTION_MODULE_NAME'
    EXPORTING
      FORMNAME           = 'ZSF_CUS_ACC_WITH_OUT_AB'
*     VARIANT            = ' '
*     DIRECT_CALL        = ' '
    IMPORTING
      FM_NAME            = FM_NAME
